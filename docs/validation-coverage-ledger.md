...
- Latest focused run scope: `postal_code`.
- Latest scorecard coverage: 5/277 (2%), grade D.
- Latest findings summary: product findings 0; ambiguous findings 0.
- Interpretation: the latest scorecard reflects the most recent focused run artifacts, not the cumulative set of concepts validated across the project.
...
- Numeric/code fields: merchant category code.
...
- Live-proven concept count before this sprint: 18 concepts.
- Live-proven behavior-family count before this sprint: approximately 9 families.
- Latest focused scorecard coverage remains 5/277 (2%) because it is latest-run scoped.
