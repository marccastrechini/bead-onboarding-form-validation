...
const EXPECTED_SHAPES: Partial<Record<FieldConceptKey, ValueShape[]>> = {
  ...
  website: ['url'],
  contact_first_name: ['text_name_like'],
  contact_last_name: ['text_name_like'],
  stakeholder_first_name: ['text_name_like'],
  stakeholder_last_name: ['text_name_like'],
  stakeholder_job_title: ['text_name_like'],
  ...
  naics: ['numeric'],
  merchant_category_code: ['numeric'],
  date_of_birth: ['date'],
  registration_date: ['date'],
  annual_revenue: ['numeric'],
  highest_monthly_volume: ['numeric'],
...
const REJECTED_SHAPES: Partial<Record<FieldConceptKey, ValueShape[]>> = {
  ...
  contact_first_name: ['email', 'phone', 'url', 'date', 'postal_code', 'percentage', 'numeric'],
  contact_last_name: ['email', 'phone', 'url', 'date', 'postal_code', 'percentage', 'numeric'],
  stakeholder_first_name: ['email', 'phone', 'url', 'date', 'postal_code', 'percentage', 'numeric'],
  stakeholder_last_name: ['email', 'phone', 'url', 'date', 'postal_code', 'percentage', 'numeric'],
  stakeholder_job_title: ['email', 'phone', 'url', 'date', 'postal_code', 'percentage', 'numeric'],
  ...
  naics: ['email', 'phone', 'url', 'date', 'postal_code', 'percentage', 'text_name_like'],
  merchant_category_code: ['email', 'phone', 'url', 'date', 'postal_code', 'percentage', 'text_name_like'],
  ...
  annual_revenue: ['email', 'phone', 'url', 'date', 'postal_code', 'percentage', 'text_name_like'],
  highest_monthly_volume: ['email', 'phone', 'url', 'date', 'postal_code', 'percentage', 'text_name_like'],
  average_ticket: ['email', 'phone', 'url', 'date', 'postal_code', 'percentage', 'text_name_like'],
  max_ticket: ['email', 'phone', 'url', 'date', 'postal_code', 'percentage', 'text_name_like'],
