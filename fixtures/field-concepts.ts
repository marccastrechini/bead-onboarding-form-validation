...
export const FIELD_CONCEPTS: FieldConceptDefinition[] = [
  ...
  },
  {
    ...
    jsonKeyPatterns: [/merchantData\.(annualRevenue|grossAnnualRevenue)$/i],
  ...
  },
  {
    ...
    jsonKeyPatterns: [/merchantData\.(averageTicket|averageTicketSize|avgTicket)$/i],
    bestPracticeValidations: MONEY_MATRIX,
    missingValidationSeverity: 'high',
    weakValidationSeverity: 'medium',
  ...
  },
  {
    ...
    jsonKeyPatterns: [/merchantData\.(maxTicket|maxTicketSize|maximumTicket)$/i],
    bestPracticeValidations: MONEY_MATRIX,
    missingValidationSeverity: 'high',
    weakValidationSeverity: 'medium',
